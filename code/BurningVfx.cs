...
public class BurningVfx : Component
{
	...
	protected override void OnUpdate()
	{
		...
		Sprite.Transform.LocalScale = new Vector3( (1f + Utils.FastSin( _timeOffset + _timeSince * _ySpeed ) * 0.1f), 1f + Utils.FastSin( _timeOffset + _timeSince * 14f ) * 0.075f, 1f ) * scaleFactor * Globals.SPRITE_SCALE;
